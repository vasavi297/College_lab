...
// Get completed experiments (Verified submissions) for the chosen subject
...
<title>Completed Experiments | SVEC</title>
...
<style>
 ...
 .modal-close { position: absolute; top: 15px; right: 20px; font-size: 1.8rem; cursor: pointer; color: var(--text-gray); transition: 0.2s; border: none; background: none; }
    ...
    @media (max-width: 768px) {
        ...
        .completed-header { flex-direction: column; align-items: flex-start; gap: 16px; }
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="completed_exp.php" class="menu-item active"> Completed Experiments</a>
            ...
            <?php else: ?>
                ...
                <?php if ($selected_subject === ''): ?>
                    <div class="empty-state">
                        ...
                        <p>Choose a subject to view your verified submissions for that course.</p>
                    </div>
                <?php elseif (empty($completed_experiments)): ?>
                    <div class="empty-state">
                        <i class="fa-regular fa-circle-check"></i>
                        <h3>No Completed Experiments</h3>
                        <p>No verified submissions found for the selected subject.</p>
                    </div>
                <?php else: ?>
                    ...
                    <div class="completed-card">
                        <div class="completed-header">
                            ...
                            <div class="marks-badge">
                                ...
                                <?php echo htmlspecialchars($exp['marks_obtained']); ?>/10 Marks
                            </div>
                        </div>
